      ...
      <>
         {site.banner && (
            <div
               ...
               className="border-color relative -mt-16 h-72 overflow-hidden border-b-2 border-zinc-100 bg-cover bg-center"
            >
               <div
         ...
         <div className="relative mx-auto -mt-10 h-20 max-w-[728px] max-tablet:px-3">
            <div className="shadow-1 absolute left-0 top-0 h-20 w-20 overflow-hidden rounded-full shadow max-tablet:left-3">
               <Image
                  //@ts-expect-error
                  url={site.icon?.url}
                  options="height=200"
         ...
         <div className="relative z-10 mx-auto -mt-[52px] max-w-[728px] max-laptop:px-3">
