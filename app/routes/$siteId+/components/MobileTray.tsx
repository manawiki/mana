...
export const MobileTray = ({
   ...
   return (
      <Drawer.Root onOpenChange={onOpenChange} open={open}>
         ...
         <Drawer.Portal>
            <Drawer.Content className="bg-2 fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-[80%] flex-col rounded-t-[10px] pb-5">
               <div className="bg-2 relative flex-1 rounded-t-[10px] p-4">
