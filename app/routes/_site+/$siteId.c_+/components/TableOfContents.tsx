...
export function TableOfContents({
   ...
   return (
      <section
         className="relative text-sm border-y max-tablet:-mx-3 tablet:border border-color-sub 
         overflow-hidden shadow-sm shadow-1 tablet:rounded-lg mb-4 bg-zinc-50 dark:bg-dark350"
      >
