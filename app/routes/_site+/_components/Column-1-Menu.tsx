         ...
         <menu className="w-full justify-between max-laptop:flex max-laptop:gap-3 relative">
            <LoggedIn>
                  ...
                  <Tooltip placement="right">
                     <TooltipTrigger asChild>
                        <NavLink
                           prefetch="viewport"
                           to="/explore"
                           className="dark:bg-dark400 border-2 dark:border-zinc-700 shadow-1 bg-white mx-auto
               text-1 inline-flex size-11 items-center justify-center dark:hover:border-zinc-600 border-zinc-200
               rounded-full shadow-sm transition duration-300 active:translate-y-0.5 hover:border-zinc-300"
                     ...
                     <TooltipContent>
                        <div className="text-sm font-semibold p-0.5">
                           Explore
                        </div>
                     </TooltipContent>
                  </Tooltip>
                           ...
                           <Tooltip placement="right">
                              <TooltipTrigger>
                                 <a
                                    target="_blank"
                                    href="/admin"
                                    className="text-zinc-400 dark:text-zinc-500 size-9 rounded-full dark:hover:bg-dark350 hover:bg-white flex items-center justify-center"
                                 >
