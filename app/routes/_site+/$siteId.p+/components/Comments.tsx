      ...
      <>
         {comments?.replies &&
            comments.replies.map((comment) => (
               <div key={comment.id} className="border-t border-color py-6">
                  <div className="flex items-center gap-2">
                     ...
                     <div className="text-xs">{comments.createdAt}</div>
                  </div>
                  <div className="pt-2.5 text-1">
                     Nisi nostra nunc quam lobortis morbi netus non sem
                     himenaeos, varius natoque ornare tempor risus curabitur
                     arcu dis. Nisi nostra nunc quam lobortis morbi netus non
                     sem himenaeos, varius natoque ornare tempor risus curabitur
                     arcu dis.
                  </div>
