...
export function PolicyTemplate({
   ...
   return (
      <div className="relative z-20 mx-auto pt-5 laptop:pt-8 max-w-[728px] max-laptop:px-4">
         ...
         <div className="pb-10">
            <Text className="pb-4">
               {site?.name ?? "Mana"} is committed to maintaining robust privacy
            ...
            <Text className="pb-4">
               The terms “we,” “us,” and “our” refer to {domain}. “You” refers
               ...
               Use and you consent to our collection, storage, use and
               disclosure of your Personal Information as described in this
               Privacy Policy.
            </Text>
            <section className="py-4">
               <Text className="pb-4 font-bold">I. INFORMATION WE COLLECT</Text>
               <Text className="pb-4">
                  ...
                  Information includes your email which you submit to us through
               ...
               <div className="pb-2">
                  ...
                  <Text className="pb-4">
                     ...
                     quality of the Service, we track information provided to us
                     by your browser or by our software application when you
                     ...
                     does not personally identify you. We track this information
                     using cookies, or small text files which include an
                     anonymous unique identifier. Cookies are sent to a user's
                     browser from our servers and are stored on the user's
                     computer hard drive. Sending a cookie to a user's browser
                     enables us to collect Non-Personal information about that
                     user and keep a record of the user's preferences when
                     utilizing our services, both on an individual and aggregate
                     basis. For example, the Company may use cookies to
                     determine the active logged in user. The Company may use
                  ...
                  <Text className="pb-4">
                     ...
                     without the consent of a parent or guardian, we will delete
                     that information as soon as possible. If you believe we
                     have collected such information, please contact us at info@
                     {domain}.
                  </Text>
               </div>
            </section>
            <section className="py-4">
               ...
               <Text className="pb-4">
                  ...
                  reasonably necessary to meet any applicable legal process or
                  enforceable governmental request; to enforce applicable Terms
                  of Service, including investigation of potential violations;
                  address fraud, security or technical concerns; or to protect
                  against harm to the rights, property, or safety of our users
               ...
               <Text className="pb-4">
                  ...
                  other third parties at our discretion. In the event we undergo
                  a business transaction such as a merger, acquisition by
                  another company, or sale of all or a portion of our assets,
                  your Personal Information may be among the assets transferred.
                  You acknowledge and consent that such transfers may occur and
                  are permitted by this Privacy Policy, and that any acquirer of
                  our assets may continue to process your Personal Information
                  as set forth in this Privacy Policy. If our information
                  practices change at any time in the future, we will post the
                  policy changes to the Site so that you may opt out of the new
                  information practices. We suggest that you check the Site
            ...
            <section className="py-4">
               ...
               <Text className="pb-4">
                  ...
                  disclosed, altered or destroyed by breach of such firewalls
            ...
            <section className="py-4">
               ...
               <Text className="pb-4">
                  ...
                  instructions provided in each promotional e-mail. You can also
                  indicate that you do not wish to receive marketing
                  communications from us in the user settings section of the
                  Site. Please note that notwithstanding the promotional
                  preferences you indicate by either unsubscribing or opting out
                  in the user settings section of the Site, we may continue to
                  send you administrative emails including, for example,
...
export default function PrivacyPolicy() {
   ...
   return <PolicyTemplate site={site} domain={domain} />;
}
