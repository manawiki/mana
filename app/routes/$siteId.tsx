      ...
      <>
         <NavLink
            ...
            className={({ isActive }) =>
               `${
                  isActive &&
                  "font-bold text-slate-800 underline dark:!text-white"
               } max-laptop:-mt-6 max-desktop:w-12 max-desktop:h-12 max-desktop:mx-auto 
                                max-desktop:bg-blue-50 max-desktop:hover:shadow 
                            dark:max-desktop:bg-blue-900 dark:max-desktop:shadow-blue-500 max-desktop:shadow-blue-200 
                            max-desktop:border max-desktop:border-blue-100 max-desktop:dark:border-blue-700 mx-3 
                            flex items-center justify-center gap-3 rounded-full
                            px-3.5 py-2 text-lg font-semibold text-slate-500 decoration-slate-300 underline-offset-4 
                            hover:underline dark:text-slate-400 dark:decoration-slate-500 desktop:justify-start`
            }
            to={to}
         >
            <Icon className="dark:max-desktop:text-white h-5 w-5 text-blue-500" />
      ...
      <>
         ...
         >
            ...
            <section>
               ...
               >
                  <NavItem to={`/${site.id}`} end name="Home" Icon={Home} />
                  <NavItem
                     to={`/${site.id}/posts`}
                     name="Posts"
                     Icon={Pencil}
