...
export function EditorVersionModal({
   ...
   return (
      <Dialog size="5xl" open={isVersionModalOpen} onClose={setVersionModal}>
         <TabGroup className="laptop:flex items-start relative gap-5">
            <TabList className="laptop:sticky laptop:top-4 flex-col min-w-[240px] overflow-auto">
            ...
            <TabPanels className="laptop:min-w-[728px]">
               {versions?.map(
                  (version: any) =>
                     version?.version?.content && (
                        <TabPanel key={version?.id}>
