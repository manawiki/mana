...
import { _ReleaseStatuses } from "../collections/_release-statuses";
...
const collectionName = "_release-statuses";
const data = require("./import_files/" + "_ReleaseStatus" + ".json");
...
const fieldConfig = _ReleaseStatuses.fields;
