...
import { _StatusEffects } from "../collections/_status-effects";
...
const collectionName = "_status-effects";
const data = require("./import_files/" + "_StatusEffect" + ".json");
...
const fieldConfig = _StatusEffects.fields;
