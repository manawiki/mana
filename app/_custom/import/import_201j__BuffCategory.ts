...
import { _BuffCategories } from "../collections/_buff-categories";
...
const collectionName = "_buff-categories";
const data = require("./import_files/" + "_BuffCategory" + ".json");
...
const fieldConfig = _BuffCategories.fields;
