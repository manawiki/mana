...
import { _NPClassifications } from "../collections/_np-classifications";
...
const collectionName = "_np-classifications";
const data = require("./import_files/" + "_NPClassification" + ".json");
...
const fieldConfig = _NPClassifications.fields;
