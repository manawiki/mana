...
import { _QuestTypes } from "../collections/_quest-types";
...
const collectionName = "_quest-types";
const data = require("./import_files/" + "_QuestType" + ".json");
...
const fieldConfig = _QuestTypes.fields;
