...
import { _CommandCards } from "../collections/_command-cards";
...
const collectionName = "_command-cards";
const data = require("./import_files/" + "_CommandCard" + ".json");
...
const fieldConfig = _CommandCards.fields;
