...
import { _Chapters } from "../collections/_chapters";
...
const collectionName = "_chapters";
const data = require("./import_files/" + "_Chapter" + ".json");
...
const fieldConfig = _Chapters.fields;
