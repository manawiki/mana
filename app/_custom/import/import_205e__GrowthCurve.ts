...
import { _GrowthCurves } from "../collections/_growth-curves";
...
const collectionName = "_growth-curves";
const data = require("./import_files/" + "_GrowthCurve" + ".json");
...
const fieldConfig = _GrowthCurves.fields;
