...
import { _Illustrators } from "../collections/_illustrators";
...
const collectionName = "_illustrators";
const data = require("./import_files/" + "_Illustrator" + ".json");
...
const fieldConfig = _Illustrators.fields;
