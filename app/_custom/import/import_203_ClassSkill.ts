...
import { ClassSkills } from "../collections/class-skills";
...
const collectionName = "class-skills";
const data = require("./import_files/" + "ClassSkill" + ".json");
...
const fieldConfig = ClassSkills.fields;
