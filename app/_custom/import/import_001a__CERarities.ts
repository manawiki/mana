...
import { _CeRarities } from "../collections/_ce-rarities";
...
const collectionName = "_ce-rarities";
const data = require("./import_files/" + "_CERarity" + ".json");
...
const fieldConfig = _CeRarities.fields;
