...
import { _Alignments } from "../collections/_alignments";
...
const collectionName = "_alignments";
const data = require("./import_files/" + "_Alignment" + ".json");
...
const fieldConfig = _Alignments.fields;
