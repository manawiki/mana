...
import { _ClassSkillTypes } from "../collections/_class-skill-types";
...
const collectionName = "_class-skill-types";
const data = require("./import_files/" + "_ClassSkillType" + ".json");
...
const fieldConfig = _ClassSkillTypes.fields;
