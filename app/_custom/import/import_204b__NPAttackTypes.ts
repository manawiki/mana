...
import { _NPAttackTypes } from "../collections/_np-attack-types";
...
const collectionName = "_np-attack-types";
const data = require("./import_files/" + "_NPAttackType" + ".json");
...
const fieldConfig = _NPAttackTypes.fields;
