...
import { _InterludeQuestRewards } from "../collections/_interlude-quest-rewards";
...
const collectionName = "_interlude-quest-rewards";
const data = require("./import_files/" + "_InterludeQuestReward" + ".json");
...
const fieldConfig = _InterludeQuestRewards.fields;
