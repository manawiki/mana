...
import { _CraftEssenceTypeSpecifics } from "../collections/_craft-essence-type-specifics";
...
const collectionName = "_craft-essence-type-specifics";
const data = require("./import_files/" + "_CETypeSpecific" + ".json");
...
const fieldConfig = _CraftEssenceTypeSpecifics.fields;
