...
import { AppendSkills } from "../collections/append-skills";
...
const collectionName = "append-skills";
const data = require("./import_files/" + "AppendSkill" + ".json");
...
const fieldConfig = AppendSkills.fields;
