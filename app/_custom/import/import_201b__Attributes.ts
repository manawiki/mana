...
import { _Attributes } from "../collections/_attributes";
...
const collectionName = "_attributes";
const data = require("./import_files/" + "_Attribute" + ".json");
...
const fieldConfig = _Attributes.fields;
