...
import { ServantSkills } from "../collections/servant-skills";
...
const collectionName = "servant-skills";
const data = require("./import_files/" + "ServantSkill" + ".json");
...
const fieldConfig = ServantSkills.fields;
