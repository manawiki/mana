...
import { _FieldTypes } from "../collections/_field-types";
...
const collectionName = "_field-types";
const data = require("./import_files/" + "_FieldType" + ".json");
...
const fieldConfig = _FieldTypes.fields;
