...
import { CraftEssences } from "../collections/craft-essences";
...
const collectionName = "craft-essences";
const data = require("./import_files/" + "CE" + ".json");
...
const forceOverwrite = true; // Force overwrite even if checksum is matching.

let payload = null as any;

const fieldConfig = CraftEssences.fields;
