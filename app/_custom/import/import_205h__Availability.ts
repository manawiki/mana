...
import { _Availabilities } from "../collections/_availabilities";
...
const collectionName = "_availabilities";
const data = require("./import_files/" + "_Availability" + ".json");
...
const fieldConfig = _Availabilities.fields;
