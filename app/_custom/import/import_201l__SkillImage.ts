...
import { _SkillImages } from "../collections/_skill-images";
...
const collectionName = "_skill-images";
const data = require("./import_files/" + "_SkillImage" + ".json");
...
const fieldConfig = _SkillImages.fields;
