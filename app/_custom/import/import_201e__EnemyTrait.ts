...
import { _EnemyTraits } from "../collections/_enemy-traits";
...
const collectionName = "_enemy-traits";
const data = require("./import_files/" + "_EnemyTrait" + ".json");
...
const fieldConfig = _EnemyTraits.fields;
