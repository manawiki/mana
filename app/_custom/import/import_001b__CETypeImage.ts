...
import { _CeTypeImages } from "../collections/_ce-type-images";
...
const collectionName = "_ce-type-images";
const data = require("./import_files/" + "_CETypeImage" + ".json");
...
const fieldConfig = _CeTypeImages.fields;
