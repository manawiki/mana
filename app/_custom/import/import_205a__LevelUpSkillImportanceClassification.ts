...
import { _LevelUpSkillImportanceClassifications } from "../collections/_level-up-skill-importance-classifications";
...
const collectionName = "_level-up-skill-importance-classifications";
const data = require(
   "./import_files/" + "_LevelUpSkillImportanceClassification" + ".json",
);
...
const fieldConfig = _LevelUpSkillImportanceClassifications.fields;
