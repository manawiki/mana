...
import { _DeckLayouts } from "../collections/_deck-layouts";
...
const collectionName = "_deck-layouts";
const data = require("./import_files/" + "_DeckLayout" + ".json");
...
const fieldConfig = _DeckLayouts.fields;
