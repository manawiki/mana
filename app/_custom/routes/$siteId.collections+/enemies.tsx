   ...
   const types = [
      {
         ...
         icon: "https://static.mana.wiki/starrail/CampAntimatterLegion.png",
      },
      {
         id: "3",
         name: "Fragmentum Monsters",
         icon: "https://static.mana.wiki/starrail/CampFragmentum.png",
      },
      {
         id: "1",
         name: "Jarilo-VI",
         icon: "https://static.mana.wiki/starrail/CampFirstWorld.png",
      },
      {
         id: "2",
         name: "The Xianzhou Luofu",
         icon: "https://static.mana.wiki/starrail/World02Icon.png",
      },
      {
         id: "4",
         name: "Simulated Universe",
         icon: "https://static.mana.wiki/starrail/EnemyIcon.png",
      },
      {
         id: "5",
         name: "Stellaron Hunters",
         icon: "https://static.mana.wiki/starrail/CampStellaronHunters.png",
      },
      {
         id: "7",
         name: "Galaxy",
         icon: "https://static.mana.wiki/starrail/CampGalaxy.png",
      },
   ];
