                ...
                <div className="w-full">
                  <div className="my-1 grid grid-cols-2 gap-1 w-full">
                    <div className="inline-flex justify-between rounded-full bg-black px-3 py-1">
                      ...
                      <div className="text-white text-sm">{baseval}</div>
                    </div>
                    <div className="inline-flex justify-between rounded-full bg-black px-3 py-1">
                      <div className="text-white text-sm font-bold">
                        {secondname}
                      </div>
                      <div className="text-white text-sm">{secondval}</div>
                    </div>
                  </div>
                </div>

                <div className="w-full">
                  <div className="my-1 font-bold border-b">{talentname}</div>
                  <div
                    className="zzz-skill-description text-xs"
...
const CHARACTERS = gql`
  query WEngines {
    WEngines(limit: 100, sort: "name", where: { name: { not_equals: null } }) {
      docs {
        id
        name
        rarity {
