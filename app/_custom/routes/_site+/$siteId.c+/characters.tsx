   ...
   const professions = [
      {
         id: "GUARD",
         name: "Guard",
         icon: chars.find((c: any) => c.profession?.id == "GUARD")?.profession
            .icon?.url,
      },
      {
         id: "CASTER",
      ...
      },
      {
         id: "DEFENDER",
         name: "Defender",
         icon: chars.find((c: any) => c.profession?.id == "DEFENDER")
            ?.profession.icon?.url,
      },
   ] as FilterOptionType[];
   const elements = [
               ...
               return (
                  ...
                  >
                     ...
                     <div className="relative w-full">
                        ...
                        {/* WeaponType */}
                        <div className="border-color shadow-1 absolute left-1 top-0 z-20 h-6 w-6 rounded-sm border bg-zinc-800 shadow">
                           <Image
                              options="aspect_ratio=1:1&height=42&width=42"
                              alt="Path"
                              className="relative inline-block object-contain"
