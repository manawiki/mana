...
export const meta: MetaFunction = () => {
   return [
      {
         title: "Privacy Policy - GamePress",
      },
   ];
};
   ...
   return (
      <>
         <div className="relative z-20 mx-auto pt-24 laptop:pt-8 max-w-[680px] max-laptop:px-4">
            ...
            <div className="pb-10">
               <Text className="pb-4">
                  GamePress is committed to maintaining robust privacy
               ...
               <Text className="pb-4">
                  ...
                  gamepress.gg website, which can be accessed at{" "}
                  <TextLink href="https://gamepress.gg">
                     https://gamepress.gg
                  </TextLink>{" "}
               ...
               <Text className="pb-4">
                  The terms “we,” “us,” and “our” refer to GamePress. “You”
               ...
               <section className="py-4">
                  ...
                  <div className="pb-2">
                     ...
                     <Text className="pb-4">
                        ...
                        contact us at contact@gamepress.gg.
                     </Text>
                  </div>
               </section>
               <section className="py-4">
