   ...
   return (
      <NavLink
         ...
         className={({ isActive, isPending }) =>
            clsx(
               "border rounded-lg p-2 pr-4 gap-2 items-center shadow-sm shadow-1 min-h-[58px]",
               isActive
                  ? "dark:bg-dark500 bg-blue-50 border-blue-200 dark:border-zinc-500"
                  : "bg-3-sub border-color-sub hover:bg-blue-50 dark:hover:bg-dark450 dark:hover:border-zinc-600 hover:border-blue-200",
            )
         }
      >
...
export function PokemonFamily({
   ...
   return (
      family && (
         <div className="flex max-laptop:flex-col gap-8 laptop:gap-4 pb-4 pt-1 justify-stretch">
            {family?.basePokemon && (
               <div className="flex flex-col gap-2 flex-grow">
                  <div className="flex items-center gap-2">
                     <div className="font-mono font-bold text-sm">Stage 1</div>
                     <span className="h-0.5 flex-grow dark:bg-dark500 bg-zinc-200 rounded-full" />
                  </div>
