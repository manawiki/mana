  ...
  return (
    <>
      ...
      {skills?.map((sk: any) => {
        ...
        return (
          <>
            <div className="bg-zinc-50 dark:bg-dark350 shadow-sm shadow-1 border border-color-sub rounded-lg px-2 py-1 grid grid-cols-6 laptop:grid-cols-12 gap-2 my-3">
              <div className="flex mr-2 rounded-full bg-zinc-300 dark:bg-zinc-700 h-12 w-12">
                <Image
                  height={50}
              ...
              <div className="inline-block mr-2 col-span-5 laptop:col-span-11">
                {/* Header */}
                <div className="">
                  <div className="font-bold inline-block mr-2">{s?.name}</div>
                  ...
                  <div className="inline-block mr-2 text-xs">
                    Max Charge Time: {s?.levels[skillLevel].max_charge_time}
                  </div>
                </div>
