   ...
   return (
      <HeadlessField
         ...
         className={clsx(
            ...
            // Base layout
            "grid grid-cols-[1.125rem_1fr] items-center gap-x-4 gap-y-1 tablet:grid-cols-[1rem_1fr]",
...
const base = [
   // Basic layout
   "relative isolate flex size-[1.125rem] items-center justify-center rounded-[0.3125rem] tablet:size-4",
   ...
   return (
      ...
      >
         <span className={clsx([base, colors[color]])}>
            <svg
               className="size-4 stroke-[--checkbox-check] opacity-0 group-data-[checked]:opacity-100 tablet:h-3.5 tablet:w-3.5"
               viewBox="0 0 14 14"
               fill="none"
            >
               {/* Checkmark icon */}
