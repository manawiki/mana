                     ...
                     <>
                        <NotFollowingSite>
                           <div className="max-laptop:hidden">
                              ...
                              <div className="flex items-center justify-center laptop:mb-4">
                     ...
                     <Menu>
                        <Menu.Button
                           className="flex h-12 w-12 items-center justify-center rounded-full 
                                        ...
                                        hover:bg-gray-50 focus:translate-y-0.5 dark:border-zinc-700
                                        dark:bg-zinc-800 dark:hover:bg-zinc-700 laptop:hidden"
                        >
                        ...
                        >
                           <Menu.Items
                              className="absolute right-0 mt-40 w-full origin-top-right 
